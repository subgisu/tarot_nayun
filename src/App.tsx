            ...
            <form className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-on-surface-variant">성함</label>
                  <input className="w-full bg-transparent border-0 border-b border-outline/30 focus:ring-0 focus:border-primary px-0 py-3 text-lg transition-all outline-none" placeholder="홍길동" type="text" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-on-surface-variant">연락처</label>
                  <input className="w-full bg-transparent border-0 border-b border-outline/30 focus:ring-0 focus:border-primary px-0 py-3 text-lg transition-all outline-none" placeholder="010-0000-0000" type="tel" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-on-surface-variant">관심 과정</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-on-surface-variant">문의 내용 (선택)</label>
                <textarea className="w-full bg-transparent border-0 border-b border-outline/30 focus:ring-0 focus:border-primary px-0 py-3 text-lg transition-all resize-none outline-none" placeholder="궁금한 사항을 남겨주세요." rows={3}></textarea>
              </div>
              <div className="flex items-center gap-3 py-4">
                <input className="rounded-sm border-outline text-primary focus:ring-primary" id="privacy" type="checkbox" />
                <label className="text-sm text-on-surface-variant" htmlFor="privacy">개인정보처리방침에 동의합니다.</label>
              </div>
              <button type="button" className="w-full bg-primary text-on-primary py-5 rounded-md text-xl font-bold shadow-2xl shadow-primary/20 hover:bg-primary-container transition-all active:scale-[0.98]">
                무료 상담 신청 완료
              </button>
            </form>
          </div>
